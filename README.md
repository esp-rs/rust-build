...
```bash
curl -LO https://github.com/esp-rs/rust-build/releases/download/v1.63.0.0/install-rust-toolchain.sh
...
```powershell
Invoke-WebRequest 'https://github.com/esp-rs/rust-build/releases/download/v1.63.0.0/Install-RustToolchain.ps1' -OutFile .\Install-RustToolchain.ps1
```
...
```
./install-rust-toolchain.sh --toolchain-version 1.63.0.0 --export-file export-esp-rust.sh
